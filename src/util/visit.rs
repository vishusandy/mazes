use crate::util::{Capacity, Index, Numerical, RowSize};
...
pub struct Visit(pub(in crate::util) usize);
...
impl RemAssign<usize> for Visit {
...
impl From<usize> for Visit {
    fn from(from: usize) -> Self {
        Self(from)
    }
}
impl From<Visit> for usize {
    fn from(from: Visit) -> Self {
        from.0
    }
}
impl From<Capacity> for Visit {
    fn from(from: Capacity) -> Self {
        from.0.into()
    }
}
impl From<RowSize> for Visit {
    fn from(from: RowSize) -> Self {
        from.0.into()
    }
}
impl From<Index> for Visit {
